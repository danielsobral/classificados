...
$total_anuncio = $a->getTotalAnuncios($filtros);
...
$por_pagina = 3; // Três itens por pagina
...
<div class="container-fluid">
    <div class="jumbotron">
        <h2>Nós temos hoje <?php echo $total_anuncio; ?> anúncios</h2>
            ...
            <form method="GET">
                ...
                <div class="form-group">
                    ...
                    <select id="preco" name="filtros[preco]" class="form-control">
						...
						<option value="201-999999999999" <?php echo ($filtros['preco']=='201-999999999999')?'selected="selected"':''; ?>>A partir de R$ 201</option>
                    </select>
                </div>
